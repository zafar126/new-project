...
const HotelCard = ({ room, index }) => {
  ...
  return (
    <Link
      ...
      className="w-full sm:w-[80%] md:w-[45%] lg:w-[22%] max-w-sm block"
    >
      <div className="relative">
        <img
          src={room.images[0]}
          alt=""
          className="w-full rounded-xl bg-white text-gray-500/90 shadow-md"
        />
        {index % 2 === 0 && (
      ...
      <div className="p-4 pt-5">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button className="px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-200 transition">
            Book Now
          </button>
        </div>
      </div>
